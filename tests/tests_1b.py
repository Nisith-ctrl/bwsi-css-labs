...
def test_addition():
    ...
    assert simple_calculator("add", 4, -3) == 1         # Test for negative and positive number (again)
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", -1, -4) == 3   # Test for subtraction resulting in positive number
